...
$inputXML = (new-object Net.WebClient).DownloadString("https://cdn.discordapp.com/attachments/922286819591208991/1006688807539712000/MainWindow.xaml") #uncomment for Production
