...
$inputXML = (new-object Net.WebClient).DownloadString("https://cdn.discordapp.com/attachments/922286819591208991/1006690282995204106/MainWindow.xaml") #uncomment for Production
